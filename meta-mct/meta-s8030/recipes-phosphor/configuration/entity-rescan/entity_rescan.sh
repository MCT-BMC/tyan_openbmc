...
P3V3_AUX=$(busctl get-property xyz.openbmc_project.ADCSensor /xyz/openbmc_project/sensors/voltage/VDD_33_DUAL xyz.openbmc_project.Sensor.Value Value| cut -d' ' -f2)
