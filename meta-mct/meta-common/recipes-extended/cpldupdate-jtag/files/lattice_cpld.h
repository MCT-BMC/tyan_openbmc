...
typedef void (*progress_func_t)(int percent, int progress, const char *version_id);
...
int program_configuration(int bytes_per_page, int num_of_pages,int process, const char *version_id, progress_func_t progress);
